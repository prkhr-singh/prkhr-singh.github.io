# Property Comparison Record: 36 Littlewood Drive, Fyansford VIC 3218

**Status:** WATCH - strong newer low-maintenance fit, but price and Fyansford ground-condition diligence matter  
**Assessment layer:** AI pre-visit assessment from current listing/profile sources; no contract reviewed  
**Prepared:** 12 May 2026  
**Primary listing sources:** Domain current listing; Realestate/property profile; Property.com.au/profile snippets; Fyansford/Highton market context sources  
**Local assets:** No listing photos copied. Because the website is intended for GitHub Pages publishing and listing media copyright/private-site status is unclear, this report preserves source URLs instead of republishing photos.
...
| Outdoor | Compact land should be low-maintenance; check whether outdoor space is actually usable/covered or just leftover side/rear yard. |

## Orientation

The listing/profile evidence available in this pass does not provide a reliable north arrow. Treat orientation as an inspection item, not a settled positive. For this block size, the most important check is whether the kitchen/living glazing faces north/east enough to avoid a dark open-plan room. If the living zone faces west, summer heat and glare will matter because compact estates often have limited eaves/shading.

Inspection check: stand in the living/kitchen and alfresco at the same time of day as a likely daily-use period, turn lights off, and use a phone compass. Reject the orientation story if the main living is south-facing and dependent on artificial lighting.

## Previous Sale Lens

The public profile sale at about $258.5k in 2019 reads like a land acquisition before the 2020 build rather than a comparable improved-house sale. That means the relevant price lens is not "profit from last house sale"; it is current replacement value, comparable Fyansford compact houses, and whether the dwelling has held up over roughly six years.

Practical implication: ask for builder details, occupancy certificate/final inspection, warranty history, maintenance records, and any drainage/settlement repairs since construction.

## Comparable Set

| Comp | Calibration takeaway |
|---|---|
| 11 Northbridge Road, Highton | Similar compact Geelong/Highton-region lifestyle, but 11 Northbridge is 3-bed/no study; Littlewood wins on bedroom utility if the living spaces are not too tight. |
| 10 Northbridge Road, Highton | Better benchmark for 4-bed plus study/retreat utility. If Littlewood has only one living zone and no study, it should not be priced as strongly as No. 10. |
| 77 Prince of Wales Avenue, Mill Park | 77 has a real office and WIP but is older; Littlewood is newer and lower maintenance, with less Melbourne-side convenience. |
| 44 Waurnvale Drive, Belmont | Waurnvale has larger internal living and land but older-shell risk; Littlewood is the cleaner low-maintenance alternative. |
